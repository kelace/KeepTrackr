...
namespace KeepTrackr.Api.Migrations.Task
{
    ...
    [Migration("20240722091917_Tasks_ExecutorsCompanyId")]
    partial class Tasks_ExecutorsCompanyId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagment.Domain.Executors.Executor", b =>
                {
                    b.OwnsOne("TaskManagment.Domain.Executors.CompanyId", "CompanyId", b1 =>
                        {
                            ...
                            b1.HasKey("ExecutorId");

                            b1.ToTable("Executors", "task");
