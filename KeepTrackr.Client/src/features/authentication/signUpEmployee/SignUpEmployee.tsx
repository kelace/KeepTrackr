...
import { Link as RouterLinkl, useNavigate, Navigate, useSearchParams } from 'react-router-dom';
import { employeeSingUp } from '../../account/accountSlice';
...
function SignUpEmployee() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        e.preventDefault();
        await dispatch(employeeSingUp({
            token: searchParams.get('token'),
            employeeId: searchParams.get('user'),
