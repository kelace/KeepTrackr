...
using Executing.Domain.Boards;
using Executing.Domain.Companies;
using Executing.Domain.Executors;

namespace Executing.Application.Commands.AddBoard
{
    public class AddBoardCommandHandler : IRequestHandler<AddBoardCommand>
    {
        ...
        public async System.Threading.Tasks.Task Handle(AddBoardCommand request, CancellationToken cancellationToken)
        {
            ...
            var board = company.CreateColumn(request.Title, request.CompanyName, executor.Id, request.Order);
