using Executing.Application.Commands.AddCard;
using Executing.Application.Commands.CreateTask;
using Executing.Application.Commands.ReorderCard;
using Executing.Application.Commands.UpdateCard;
...
namespace Executing.Api.Controllers
{
    ...
    public class CardsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post(AddCardCommand command)
        {
            ...
            //todo:change all domain objects to dtos in layers that are out domain layer
